...
export const wpRender = defineTool({
  ...
  description:
    'POST /render — runs do_blocks() inside a faux main-query guard so dynamic blocks produce their real front-end output. This is the oracle input for dynamic-block output and the source of the stylesheet URLs wp_verify needs. Pass markup produced by wp_compile, never hand-written markup.',
